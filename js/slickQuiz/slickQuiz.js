    ...
    $.slickQuiz = function (element, options) {
        ...
        plugin.method = {
            ...
            setupQuiz: function (options) { // use 'options' object to pass args
                ...
                $quizHeader.hide().prepend($('<div class="quizDescription text-center">' + quizValues.info.main + '</div>')).fadeIn(1000, kN(key, 2));
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.displayQuestionCount) {
                            questionHTML.append('<div class="' + questionCountClass + ' text-right">' +
                        ...
                        questionHTML.append('<h3 class="text-blue1 text-left">' + formatQuestion + '</h3>');
                        ...
                        var answerHTML = $('<ul class="' + answersClass + ' text-left"></ul>');
